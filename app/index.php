        ...
        <h3 class="round-header"><span class="brand-primary"><?php echo $currentRound ?></span>. kolejka Ekstraklasy
            ...
            <div class="bet-panel">
                ...
                if ($result->num_rows > 0) {
                    echo "<form method='post' action='action/submit_picks.php'>";
                    ...
                    echo "</div>";
                    echo "<label class='user-label'><i class='fas fa-user fa-xs' style='margin-right: 7px;'>
                    </i>&nbsp;Nazwa gracza: <input type='text' name='username' required></label><br>";
                    echo "<table>";
